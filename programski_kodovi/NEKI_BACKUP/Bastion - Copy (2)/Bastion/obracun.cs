...
namespace Bastion
{
    public partial class obracun : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string upit = "Select sum(broj_gostiju) AS gosti,sum(iznos) as Iznos from racun where datum_kreiranja='" + DateTime.Now.ToString("yyyy-MM-dd") + "'";
            dodavaj d = new dodavaj();
            List<dodavaj> obracun_dana = null;
            try
            {
                obracun_dana = d.obracun_danas(3, upit);
