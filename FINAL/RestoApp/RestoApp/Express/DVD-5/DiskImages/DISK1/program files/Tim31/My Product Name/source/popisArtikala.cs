...
namespace Bastion
{
    public partial class popisArtikala : Form
    {
        ...
        public void kreirajDataGrid()
        {
            ...
            this.dataGridView1.Columns[dataGridView1.ColumnCount-1].Visible = false;
        }
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
                odabraniArtiklID = int.Parse(dataGridView1.CurrentRow.Cells[dataGridView1.ColumnCount - 5].Value.ToString());
            }
        }
