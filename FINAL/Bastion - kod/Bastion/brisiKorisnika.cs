...
namespace Bastion
{
    public partial class brisiKorisnika : Form
    {
        ...
        private void brisiKorisnika_Load(object sender, EventArgs e)
        {
            ...
            {
                comboBoxMoj.Items.Add("Ime: " + artikl.Ime + ", Prezime: " + artikl.Prezime + ", Id: " + artikl.Id);
        ...
        {
            string a = comboBoxMoj.SelectedItem.ToString();
            string[] b = a.Split(':');
            this.idOdabranoga = int.Parse(b[3].ToString());
